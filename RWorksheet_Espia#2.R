...
#10
#a.
vegetables <- c("Eggplant", "Carrot", "Broccoli", "Cabbage", "Tomato", "Potato", "Cucumber", "Lettuce", "Mushroom", "Cauliflower")
vegetables
#b.
vegetables <- c(vegetables, "Celery", "Spring Onion")
vegetables
#c.
vegetables <- append(vegetables, c("Asparagus", "Arugula", "Artichoke", "Spinach"), after = 5)
