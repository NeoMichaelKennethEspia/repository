...
``` {r num4a}
shoepow <-  read.csv("Shoe_sizes.csv")
shoepow
shoemai <- shoepow[c(1:6),]
shoemai
```

``` {r num4b}
female_data <- subset(shoepow, Gender == "F")
female_data
male_data <- subset(shoepow, Gender == "M")
male_data
nrow(female_data)
nrow(male_data)
...
``` {r num4c}
GraphMF<- table(shoepow$Gender)
barplot(GraphMF,
        main = "Number of Males and Females",
        xlab = "Gender",
        ylab = "Count",
        col = c("dodgerblue", "khaki"),
...
pie(Expenses,
    ...
    col = c("lightblue", "green", "pink", "khaki"),  
...
clors <- c("midnightblue", "chartreuse", "aquamarine")
